...
function App() {
  // Coloca o CGL em tela cheia após a primeira interação do usuário.
  // Em navegadores que não suportam Fullscreen API, o app continua funcionando normalmente.
  useEffect(() => {
    let ativado = false;

    const entrarEmTelaCheia = async () => {
      if (ativado || document.fullscreenElement) return;
      ativado = true;
      ...
      try {
        ...
        // Alguns navegadores bloqueiam tela cheia ou não oferecem essa API.
        // Nesse caso, o CGL permanece funcionando normalmente.
      }
    };

    document.addEventListener("pointerdown", entrarEmTelaCheia, {
      once: true,
      passive: true,
    });
